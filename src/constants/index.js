...
export const repoLink = "https://sachinkashyap1.netlify.app";

export const callToAction = "https://www.linkedin.com/in/sachin-kashyap9800";
...
export const educationList = [
  {
    ...
    content1: "Graduated with Information and Technology, Mumbai University",
  },
  {
    id: "education-2",
    icon: pba,
    title: "Morning Star High School",
    degree: "",
    duration: "May 2017 - May 2018",
    content1: "Completed my Secondary School Education From Maharashtra board",
  },
];
    ...
    positions: [
      {
        ...
        content: [
          {
            text: "Working in Troubleshooting and hardware Management.",
            link: "",
          },
        ],
      },
      {
        ...
        content: [
          {
            text: "Provided technical support and troubleshooting for hardware and software issues",
            link: "",
          },
          {
            text: "support network setup and maintenance, resolving connectivity issues",
            link: ""
          }
        ],
      },
...
export const socialMedia = [
  {
    id: "social-media-1",
    icon: AiFillLinkedin,
    link: "https://www.linkedin.com/in/sachin-kashyap9800",
  },
  {
    id: "social-media-2",
    icon: AiFillGithub,
...
On Fri, Jan 3, 2025 at 3:28 PM Shreya Office <shreyaoffice32@gmail.com> wrote:
import {
  nitk,
  cluboard,
  cash_flow,
